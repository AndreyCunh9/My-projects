...
df_protheus = pd.read_csv(caminho_csv_protheus, encoding='latin1')

# Selecionar múltiplas colunas e renomear
colunas_selecionadas = df[
    ['Filiais', 'Dados Cliente', 'Tipo Produto', 'Parcela', 'Valor Pago (R$)', 'Data do Pagamento']]
...
df_protheus['Filial'] = df_protheus['Filial'].astype(str)
