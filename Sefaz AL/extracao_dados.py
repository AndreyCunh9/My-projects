        ...
        try:
            ...
            botao_sit_aberto = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.XPATH,
                                            '/html/body/jhi-main/div[2]/div/jhi-calculo-nfe/div/jhi-filtros-pesquisa/form/div/fieldset/div/div/div[4]/jhi-select-situacoes/form/ng-select/ng-dropdown-panel/div/div[2]/div[1]'))
            )
